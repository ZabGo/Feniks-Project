  ...
  <Fragment>
      <form>
        <div className="content-block">
          ...
          <div className="form-group row">
            <label for="gp" className="col-sm-2 col-form-label">GP Name and Practice</label>
            <div className="col-sm-9">
        ...
        <div className="content-block">
          ...
          <div className="form-group">
            <div className="form-check">
              ...
              <label className="form-check-label" for="leavemessage">Tick if we can leave a message on your voicemail</label>
            </div>
            <div className="form-check">
              <input type="checkbox" id="fromfeniks" name="fromfeniks" className="form-check-input" value="2"/>
              <label className="form-check-label" for="fromfeniks">Tick if we can say we are calling from Feniks</label>
            </div>
            <div className="form-check">
              <input type="checkbox" id="mailing" name="mailing" className="form-check-input" value="2"/>
              <label className="form-check-label" for="mailing">Tick if you agree to be added to our mailing list to be informed about news, services and projects</label>
            </div>
          </div>
        </div>
        ...
        <div className="content-block">
          ...
          <div className="form-group form-check form-check-inline">
            ...
            <label className="form-check-label" for="project4">Toddler Group</label>
            <input type="checkbox" id="project5" name="project5" className="form-check-input" value="5"/>
            <label className="form-check-label" for="project5">Survivors' Group</label>
            <input type="checkbox" id="project6" name="project6" className="form-check-input" value="6"/>
            <label className="form-check-label" for="project6">Personal Development Workshops</label>
          </div>
          <br/>
          <div className="form-group form-check form-check-inline">
            <input type="checkbox" id="project7" name="project7" className="form-check-input" value="7"/>
            <label className="form-check-label" for="project7">Leith Conversation Cafes</label>
            <input type="checkbox" id="project8" name="project8" className="form-check-input" value="8"/>
            <label className="form-check-label" for="project8">SMART Recovery</label>
            <input type="checkbox" id="project9" name="project9" className="form-check-input" value="9"/>
            <label className="form-check-label" for="project9">Other</label>
          </div>
        </div>
