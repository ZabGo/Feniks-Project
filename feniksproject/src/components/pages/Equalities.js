      ...
      <form>
        <div className="content-block">
          ...
          <div className="row">
            <div className="col-sm-12">
              <ul>
                <li>Age (add script to calculate from DOB): {props.location.state.dob}</li>
                <li>Employment (add script to translate to text): {props.location.state.employment}</li>
                <li>Where did you hear about Feniks? (add script to translate to text): {props.location.state.hear}</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="content-block">
          <div className="form-group btn-group" role="group" aria-label="Submission Buttons">
            <Link to='/clients' className="btn btn-lg btn-success">Demo Submit</Link>
            <button type="submit" className="btn btn-lg btn-success disabled" disabled="disabled">Submit</button>
